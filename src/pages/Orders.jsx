...
const MOCK_ORDERS = [
  {
    ...
    total: '₹1,240',
    items: [
      { name: 'Cetaphil Cleanser', image: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&q=80&w=200' },
      { name: 'Minimalist Serum', image: 'https://images.unsplash.com/photo-1629198688000-71f23e745b6e?auto=format&fit=crop&q=80&w=200' }
    ]
  },
  {
    id: 'NYK-10927552',
    ...
    total: '₹599',
    items: [
      { name: 'Plum Moisturizer', image: 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?auto=format&fit=crop&q=80&w=200' }
    ]
  }
];
        ...
        <div className="space-y-6">
          {MOCK_ORDERS.map((order, idx) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h4 className="text-sm font-black text-gray-900 tracking-tight">Order #{order.id}</h4>
          ...
          {MOCK_ORDERS.length === 0 && (
            <div className="text-center py-24">
              <div className="w-24 h-24 bg-white rounded-[2rem] shadow-xl shadow-gray-100 flex items-center justify-center mx-auto mb-8 border border-gray-50">
